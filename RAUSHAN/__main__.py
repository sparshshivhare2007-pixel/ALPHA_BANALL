    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("🔸 ❍ᴡɴᴇʀ🔸", url="https://t.me/shizuka_bots"),
                    InlineKeyboardButton("▫️ 𝗨ᴘᴅᴀᴛᴇs ▫️", url="https://t.me/shizuka_bots")
                ]                
            ]
        )
    )
